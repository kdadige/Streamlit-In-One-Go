...
df = pd.read_csv('/Users/keerthidadige/PycharmProjects/Streamlit/lang_data.csv')
...
df = pd.read_csv('/Users/keerthidadige/PycharmProjects/Streamlit/tips.csv')
...
st.subheader('3.3 Pie Chart with Mulitiple Parameters')
